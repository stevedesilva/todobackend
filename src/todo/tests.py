...
class TestCreateTodoItem(APITestCase):
  ...
  # self.assertEqual(self.response.status_code, status.HTTP_201_CREATED) self.assertEqual(self.response.status_code, status.HTTP_200_OK)
  ...
  def test_item_was_correct_title(self):
